...
async function seedData() {
  try {
    ...
    // Calcular totais
    const lastBalance = balancesData[balancesData.length - 1];
    ...
    console.log('\n📊 RESULTADOS - CONFERÊNCIA COM A PLANILHA:');
    console.log('=' .repeat(50));
    console.log(`📌 Total de Ativos (O11): ${lastBalance.totalAssets.toFixed(2)}`);
    console.log(`📌 Total de Passivos (O25): ${lastBalance.totalLiabilities.toFixed(2)}`);
    console.log(`📌 Total das Variações (O27): ${totalVariation.toFixed(2)}`);
