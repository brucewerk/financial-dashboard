...
const Reports = () => {
  ...
  // Versão curta pro eixo Y no celular — evita o rótulo cortado quando o
  // valor completo ("R$ 4.000.000,00") não cabe na largura do eixo.
            ...
            <Box sx={{ width: '100%', height: 380 }}>
              <ResponsiveContainer>
                ...
                >
                  ...
                  />
                  <YAxis 
                    tickFormatter={(value) => isMobile ? formatCurrencyCompact(value) : formatCurrency(value)}
                    tick={{ fontSize: isMobile ? 9 : 11, fill: darkMode ? '#aaa' : '#666' }}
