...
const Evolution = () => {
  ...
  const filteredBalances = monthlyBalances.filter(
  ...
  return (
    ...
    >
      ...
      <Paper sx={{ p: { xs: 2, sm: 3 }, mb: 4, elevation: 0 }}>
                ...
                <Card sx={{ backgroundColor: "#fff3e0", height: "100%" }}>
                  <CardContent sx={{ py: { xs: 1, sm: 2 } }}>
                    ...
                    <Typography
                      variant="h6"
                      color={
                        yearTotalVariation >= 0 ? "success.main" : "error.main"
                      }
                      sx={{
                        fontSize: { xs: "0.9rem", sm: "1.1rem", md: "1.2rem" },
                        fontWeight: "bold",
      ...
      >
        ...
        <Box
          sx={{ width: "100%", height: isMobile ? 380 : isTablet ? 450 : 520 }}
        >
      ...
      >
        ...
        <Box
          sx={{ width: "100%", height: isMobile ? 320 : isTablet ? 370 : 420 }}
        >
          <ResponsiveContainer width="100%" height="100%">
            <BarChart
              data={variationData}
        ...
        >
          ...
          <tbody>
            {filteredBalances.length === 0 ? (
              ...
              filteredBalances.map((b, index) => {
                const patrimonio =
                  (b.totalAssets || 0) - (b.totalLiabilities || 0);
                return (
                  <tr key={b._id} style={{ borderBottom: "1px solid #eee" }}>
                    ...
                    <td style={{ textAlign: "right", padding: "10px" }}>
                      {formatCurrency(b.totalLiabilities)}
                    </td>
                    <td
                      style={{
                        textAlign: "right",
                    ...
                    <td
                      style={{
                        textAlign: "right",
                        padding: "10px",
                        color: variations[index] >= 0 ? "#2e7d32" : "#dc004e",
                      }}
                    >
          ...
          <tfoot>
            ...
            >
              <td style={{ padding: "12px" }}>TOTAL {selectedYear}</td>
              ...
              <td
                style={{
                  textAlign: "right",
                  padding: "12px",
                  color: yearTotalVariation >= 0 ? "#2e7d32" : "#dc004e",
                }}
              >
                {formatCurrency(yearTotalVariation)}
              </td>
