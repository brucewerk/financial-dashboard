...
const Evolution = () => {
  ...
  // Versão curta pro eixo Y no celular — "R$ 4.000.000,00" não cabe em
  // ~70px de largura; "R$4,0M" cabe. O valor completo continua aparecendo
  // no tooltip ao tocar/passar o mouse.
